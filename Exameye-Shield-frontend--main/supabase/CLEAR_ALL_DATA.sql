-- ============================================================================
-- CLEAR ALL DATA AND STORAGE FILES - Standalone Script
-- ============================================================================
...
-- 4. Check the output messages to verify deletion
-- ============================================================================
...
-- Delete files from PDF reports bucket (if exists)
DELETE FROM storage.objects WHERE bucket_id = 'pdf-reports';

-- Delete files from subject-specific buckets (if they exist)
...
-- ============================================================================
-- STEP 3: Verify deletion and display summary
-- ============================================================================
DO $$
DECLARE
...
BEGIN
  ...
  SELECT COUNT(*) INTO subject_files_count FROM storage.objects WHERE bucket_id IN (
    'data-structure-etcs214a',
    'engineering-mathematics-etcs332b',
    'operating-system-etcs456a',
    'theory-of-computation-etcs75a',
  ...
  RAISE NOTICE '  ✓ Subject Files: % files', subject_files_count;
  RAISE NOTICE '';
  RAISE NOTICE '✅ PRESERVED:';
  RAISE NOTICE '  ✓ Table structure (columns, types)';
  RAISE NOTICE '  ✓ Foreign key relationships';
  RAISE NOTICE '  ✓ Indexes and constraints';
  RAISE NOTICE '  ✓ RLS policies';
  RAISE NOTICE '  ✓ Triggers and functions';
  RAISE NOTICE '  ✓ Storage bucket structure';
  RAISE NOTICE '  ✓ Storage bucket policies';
  RAISE NOTICE '';
  RAISE NOTICE '🎉 Your database is now clean and ready for new data!';
  RAISE NOTICE '═══════════════════════════════════════════════════════════════';
END $$;
